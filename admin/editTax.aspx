<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editTax.aspx.cs" Inherits="admin_editTax" %>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Edit Taxes <small>Make all the changes you want</small>
			</h3>
			<div class="page-bar">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body form">
								<div class="form-body">
									<div class="form-group">
										...
										<div class="input-group">
                                            ...
                                            <asp:TextBox ID="taxName" runat="server" required="required" class="form-control" placeholder="ex: VAT"></asp:TextBox>
										</div>
									</div>
                                    <div class="form-group">
										...
										<div class="input-group">
                                            ...
                                            <asp:TextBox ID="taxPercent" runat="server" required="required" class="form-control" placeholder="ex: 3.5%" onkeypress="javascript:return isNumber (event)"></asp:TextBox>
								...
								<div class="form-actions">
                                    ...
                                    <asp:Button ID="updateTax" runat="server" Text="Update" CssClass="btn btn-primary" OnClick="updateTax_Click" />
