<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manageAttributes.aspx.cs" Inherits="admin_manageAttributes" %>
...
<head>
<meta charset="utf-8"/>
<title>Catalogue | Attributes</title>
...
<link rel="shortcut icon" href="favicon.ico"/>
     <script type="text/javascript">
         ...
         function delAttribute() {
             var x = confirm("Are you sure you want to delete this attribute?");
             if (x == true)
                 return true;
             else;
             return false;
         ...
         function multiDelete() {
             ...
             if (vals != "") {
                 var x = confirm("Are you sure you want to delete the selected attributes?");
                 if (x == true) {
                     window.location = "../delete.aspx?delId=multiattr&&delValue=" + vals;
                 }
                 return false;
             }
             else {
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-buysellads"></i>Attributes
							</div>
                                           ...
                                           <div class="modal-body">
                                                   ...
                                                   <div class="row">
                                                     ...
                                                     <div class="form-group">
			                                                <label class="control-label">Attribute Name<small>&nbsp;&nbsp;Mandatory</small></label>
			                                                          <div class="input-icon">
				                                                         <i class="fa fa-buysellads"></i>
                                                                          <asp:TextBox ID="attr" runat="server" class="form-control" required="required" type="text" autocomplete="off" placeholder="ex: potency"></asp:TextBox>			                                                               </div>
		                                                  </div>
                                                           <div class="form-group">
			                                                <label class="control-label">Measuring Unit(Optional):</label>
			                                                          <div class="input-icon">
				                                                         <i class="fa fa-money"></i>
                                                                          <asp:TextBox ID="units" runat="server" class="form-control" type="text" autocomplete="off" placeholder="ex:mili-gram"></asp:TextBox>			                                                               </div>
		                                                  </div>

                                                       </div>
                                                           <div class="col-md-12">
                                                               <div class="form-group">
                                                             <label class="control-label">Applies to Categories<small>&nbsp;&nbsp;Mandatory</small></label>
                                                             <asp:CheckBoxList ID="categoryList" runat="server" required="required">
                                               ...
                                               <div class="row">
                                                   <div class="col-md-12 pull-right">
                                                       <div class="form-group">
                                                          ...
                                                          <asp:Button ID="submitBtn" runat="server" Text="Add Attribute" CssClass="btn btn-success" OnClick="submitBtn_Click" OnClientClick=" return validateCategory()" />
