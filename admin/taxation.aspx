<%@ Page Language="C#" AutoEventWireup="true" CodeFile="taxation.aspx.cs" Inherits="admin_taxation" %>
...
<link rel="shortcut icon" href="favicon.ico"/>
    <script>
        ...
        function multiDelete() {
            ...
            if (vals != "") {
                var x = confirm("Are you sure you want to delete the selected taxes?");
                if (x == true) {
                    window.location = "../delete.aspx?delId=multitaxes&delValue=" + vals;
                }
                return false;
            }
            else {
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Taxation Policies <small>Create taxex that will be collected on all transactions</small>
			</h3>
			<div class="page-bar">
			...
			<div class="row">
				...
				<div class="col-md-8 ">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i> Create a new Tax
							</div>
						...
						<div class="portlet-body form">
								<div class="form-body">
									<div class="form-group">
										...
										<div class="input-group">
                                            ...
                                            <asp:TextBox ID="taxName" required="required" runat="server" class="form-control" placeholder="ex: VAT"></asp:TextBox>
										</div>
									</div>
                                    <div class="form-group">
										...
										<div class="input-group">
                                            ...
                                            <asp:TextBox ID="taxPercent" required="required" runat="server" class="form-control" placeholder="ex: 3.5%" onkeypress="javascript:return isNumber (event)"></asp:TextBox>
								...
								<div class="form-actions">
                                    <asp:Button ID="reset" runat="server" Text="Reset" OnClientClick="return clearAll()" CssClass="btn btn-info"  />
                                    <asp:Button ID="createTax" runat="server" Text="Create Tax" CssClass="btn btn-primary" OnClick="createTax_Click" />
								</div>
						</div>
					</div>
				...
				<div class="col-md-8 ">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-bars"></i> Existing Taxes
							</div>
