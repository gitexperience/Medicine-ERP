<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editAttribute.aspx.cs" Inherits="admin_editAttribute" %>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Edit Attribute <small>Make all the changes you want</small>
			</h3>
			<div class="page-bar">
								...
								<div class="form-body">
									<div class="form-group">
										...
										<div class="input-group">
                                            ...
                                            <asp:TextBox ID="attrName" runat="server" class="form-control" placeholder="ex: potency"></asp:TextBox>
										</div>
									</div>
                                    <div class="form-group">
										...
										<div class="input-group">
                                            ...
                                            <asp:TextBox ID="measureUnit" runat="server" class="form-control" placeholder="ex: milli-grams"></asp:TextBox>
										</div>
									</div>
                                     <div class="form-group">
