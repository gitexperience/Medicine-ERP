<%@ Page Language="C#" AutoEventWireup="true" CodeFile="emailSettings.aspx.cs" Inherits="admin_emailSettings" %>
<DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8"/>
<title>Settings | Email Settings</title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Email Settings<small>    These will be used to send all e-mails.</small>
			</h3>
			<div class="page-bar">
				...
				<div class="col-md-12 ">
                    ...
                    <div class="col-md-10">
						...
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-wrench"></i> Present Settings
							</div>
						</div>
						<div class="portlet-body form">
							<form id="Form1" role="form" runat="server">
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<i class="fa fa-server"></i>
										     ...
										     <asp:TextBox ID="hostTxt" runat="server" class="form-control" required="required" placeholder="No Host Provided"></asp:TextBox>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="input-group">
                                            ...
                                            <asp:TextBox ID="portNum" required="required" runat="server" class="form-control" placeholder="No E-mail address provided" onkeypress="javascript:return isNumber (event)"></asp:TextBox>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="input-group">
                                            ...
                                            <asp:TextBox ID="unameTxt" required="required" runat="server" class="form-control" placeholder="No User Name provided"></asp:TextBox>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="input-group">
                                            ...
                                            <asp:TextBox ID="passTxt" required="required" runat="server" class="form-control" TextMode="Password" placeholder="No Password provided"></asp:TextBox>
										</div>
									</div>
								...
								<div class="form-actions">
                                    <asp:Button runat="server" ID="editButton" Text="Edit Settings" CssClass="btn btn-info" OnClick="editButton_Click" /> 
