<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bidaward.aspx.cs" Inherits="Bidaward" %>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>Bid Products
							</div>
						...
						<div class="portlet-body">
							...
							<asp:PlaceHolder ID = "PlaceHolder1" runat="server" />
                                <div class="row">
                                        <div class="col-md-10"><asp:Label ID="Label1" runat="server" Text="" CssClass="btn btn-success"></asp:Label></div>
                                    <div class="col-md-2">
                                            <asp:Button ID="bidaward" runat="server" Text="Award Bid" CssClass="btn btn-primary red" />
                                    </div>
                                </div>
