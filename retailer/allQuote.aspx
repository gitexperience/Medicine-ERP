<%@ Page Language="C#" AutoEventWireup="true" CodeFile="allQuote.aspx.cs" Inherits="allQuote" %>
...
to completely remove the below "sidebar-search-wrapper" LI element -->
                ...
                <li>
                                        <a href="javascript:;">
                                        <i class="icon-logout"></i>
                                        <span class="title">Place Another Quotation</span>
				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>All Quotes
							</div>
