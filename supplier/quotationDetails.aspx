<%@ Page Language="C#" AutoEventWireup="true" CodeFile="quotationDetails.aspx.cs" Inherits="supplier_quotationDetails" %>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<h3 class="page-title">
			Quotation Details <small>Requested Medicines and Products</small>
			</h3>
			<div class="page-bar">
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div id="tableName" runat="server" class="caption">
						...
						<div class="portlet-body">
                            ...
                            <div class="row" >
                                <div class="col-md-12">
                                    ...
                                    <asp:Label ID="Label2" runat="server" class='btn btn-success btn-sm'></asp:Label>
                                    <asp:Label ID="Label3" runat="server" class='btn btn-success btn-sm'></asp:Label>
                                    <asp:Button ID="placeBid" runat="server" Text="Place Your Bid" CssClass="btn btn-primary pull-right" OnClick="placeBid_Click" />
